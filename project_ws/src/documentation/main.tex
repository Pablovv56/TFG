...
\begin{abstract}
  ...
  \begin{figure}[h]
    \centering
      \includegraphics[width=0.6\textwidth]{clean_map_intro.png}
    \caption{Image of the generated map.}
  \end{figure}\newline
...
\begin{abstract}
  ...
  Tecnologías como la visión por computador, el mapeo simultáneo (SLAM\cite{smith1987slam}) y los sensores avanzados permiten que estos robots eviten 
  ...
  \begin{figure}[h]
    \centering
      \includegraphics[width=0.6\textwidth]{clean_map_intro.png}
    \caption{Imagen del mapa generado.}
  \end{figure}\newline
  ...
  recibiendo como única fuente de datos nubes de puntos capturadas del entorno.\newpage Para llevar a cabo esta tarea, este proyecto se apoya 
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    lo que es útil en aplicaciones de visión por computador y reconstrucción 3D.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{figure}[h]
      ...
      en aplicaciones de visión por computador, robótica y reconstrucción 3D. Su objetivo es encontrar la transformación rígida óptima (rotación y traslación) que minimice la 
